# run-migration.ps1
# Скрипт для выполнения миграций в statistics-service
...
Write-Host "Database Migrations for statistics-service" -ForegroundColor Cyan

if (!(Test-Path "package.json")) {
    Write-Host "Error: package.json not found. Make sure you are in statistics-service directory" -ForegroundColor Red
    exit 1
}
