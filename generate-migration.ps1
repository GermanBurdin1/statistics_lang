...
# Скрипт для генерации новых миграций в statistics-service
...
if (!(Test-Path "package.json")) {
    Write-Host "❌ Ошибка: package.json не найден. Убедитесь, что вы в директории statistics-service" -ForegroundColor Red
    exit 1
}
